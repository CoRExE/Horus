...
vi.mock('../src/services/native', () => ({ nativeText: vi.fn(), invoke: vi.fn() }));
...
function Harness() {
  ...
  return <><UpdateNotice updates={updates} /><SettingsScreen apiInput="" setApiInput={() => {}} saveApiUrl={() => {}} version="0.1.1" runtime={runtime} updates={updates} /></>;
}
beforeEach(() => { localStorage.clear(); vi.resetAllMocks(); vi.mocked(invoke).mockResolvedValue(undefined); });
